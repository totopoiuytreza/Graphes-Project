...
class AppGraphe(tk.Tk):
    ...
    def createPage(self):
        ...
        self.page_info = tk.Frame(master=self.page_menu, bg="white", width=(self.Largeur/2)-5, height=(self.Hauteur/2)-5)
        ...
        self.page_choix = tk.Frame(master=self.page_menu, bg="white", width=(self.Largeur/2)-5, height=(self.Hauteur/2)-5)
        ...
        self.page_choix_combobox = ttk.Combobox(master=self.page_choix, values=self.liste_graphes, state="readonly", width=40)
        ...
        self.page_tableau = tk.Frame(master=self.page_menu, bg="white", width=(self.Largeur/2)-5, height=(self.Hauteur/2)-5)
        ...
        self.page_tableau_treeview = ttk.Treeview(master=self.page_tableau, columns=("Valeur", "Valeur initiale"), show="headings") #TODO: A modifier

        #Creation de la page choix des boutons
        self.page_boutons = tk.Frame(master=self.page_menu, bg="white", width=(self.Largeur/2)-5, height=(self.Hauteur/2)-5)
        ...
        self.page_boutons_ordonnancement_verif.bind("<Button-Ordonnancement>") #TODO: A modifier
        self.page_boutons_affiche_graphe = tk.Button(master=self.page_boutons, text="Show the graphe", bg="white", fg="black", font=("Arial", 10))
        self.page_boutons_affiche_graphe.bind("<Button-AfficheGraphe>") #TODO: A modifier
        ...
        self.page_tableau_treeview.grid(row=1, column=0, sticky="nw", padx=5, pady=5)
